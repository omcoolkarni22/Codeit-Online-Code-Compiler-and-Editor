...
urlpatterns = [
    ...
    path('returnAllSharedCode', AllSharedCode, name='returnAllSharedCode'),  # return shared saved codes
    ...
    path('deleteSharedCode', deleteSharedCode, name='deleteSharedCode'),  # delete saved code
